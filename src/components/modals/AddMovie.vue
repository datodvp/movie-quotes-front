    ...
    <template #body>
      ...
      >
        ...
        <div
          ...
          class="bg-transparent relative py-[0.688rem] w-full border border-[#6C757D] flex flex-wrap h-fit items-center rounded-[4.8px] text-xl pl-4 pr-12"
        >
          ...
          <div
            ...
            class="text-sm bg-[#6C757D] mr-1 py-[0.313rem] px-[0.375rem]"
          >
